...
static UI_VS: &'static str = include_str!("./ui-vertex.glsl");
static UI_FS: &'static str = include_str!("./ui-fragment.glsl");

static UI_PICK_VS: &'static str = include_str!("./ui-vertex-picking.glsl");
static UI_PICK_FS: &'static str = include_str!("./ui-fragment-picking.glsl");
...
impl ShaderSystem {
    ...
    pub fn new(gl: &WebGl2RenderingContext) -> ShaderSystem {
        ...
        let ui_pick_shader = Shader::new(&gl, UI_PICK_VS, UI_PICK_FS).unwrap();
